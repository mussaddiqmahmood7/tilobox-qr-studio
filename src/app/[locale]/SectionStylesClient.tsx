    ...
    return (
      ...
      >
        <div className="block">
          <motion.div
            className={cn(
              "relative w-[125px] sm:w-[150px] lg:w-[170px] rounded-xl bg-accent/30 overflow-hidden shadow-2xs",
            )}
            whileTap={{
              scale: 0.95,
              opacity: 0.8,
          ...
          >
            ...
            <div
              className={cn(
                "absolute top-0 left-0 w-full h-full rounded-xl ring ring-inset",
                isActive
                  ? "ring-2 ring-primary"
  ...
  return (
    <div className="mt-3">
      <Container>
        ...
        <div
          className="w-full overflow-x-auto no-scrollbar snap-x snap-mandatory py-0.5"
          {...events}
          ref={ref}
        >
          <div className="flex gap-2.5 min-w-max pb-1.5">
